...
exports.groupResponse_Remove = async (yudamods, update) => {
try {
ppuser = await yudamods.profilePictureUrl(num, 'image')
} catch {
ppuser = 'https://telegra.ph/file/265c672094dfa87caea19.jpg'
}
const metadata = await yudamods.groupMetadata(update.id)
for (let participant of update.participants) {
try{
let metadata = await yudamods.groupMetadata(update.id)
...
exports.groupResponse_Welcome = async (yudamods, update) => {
try {
ppuser = await yudamods.profilePictureUrl(num, 'image')
} catch {
ppuser = 'https://telegra.ph/file/265c672094dfa87caea19.jpg'
...
exports.groupResponse_Promote = async (yudamods, update) => {  
const metadata = await yudamods.groupMetadata(update.id)   
for (let participant of update.participants) {
try{
let metadata = await yudamods.groupMetadata(update.id)
...
exports.groupResponse_Demote = async (yudamods, update) => {  
const metadata = await yudamods.groupMetadata(update.id)   
for (let participant of update.participants) {
try{
let metadata = await yudamods.groupMetadata(update.id)
