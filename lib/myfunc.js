...
// exports serialize
exports.serialize = (yudamods, msg) => {
...
msg.quotedMsg.fromMe = msg.quotedMsg.sender === yudamods.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
if (msg.key.fromMe){
msg.sender = yudamods.user.id.split(':')[0]+'@s.whatsapp.net'
}
